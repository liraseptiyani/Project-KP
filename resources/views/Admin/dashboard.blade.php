...
<div class="container py-4">
    ...
    <div class="fitur-grid">
        <div class="fitur-box">
            ...
            <div class="fitur-jumlah">{{ $totalBarang }}</div>
        </div>
        <div class="fitur-box">
            <div class="fitur-nama">Barang Masuk</div>
            <div class="fitur-jumlah">{{ $totalMasuk }}</div>
        </div>
        <div class="fitur-box">
            <div class="fitur-nama">Barang Keluar</div>
            <div class="fitur-jumlah">{{ $totalKeluar }}</div>
        </div>
        <div class="fitur-box">
            <div class="fitur-nama">Data Barang</div>
            <div class="fitur-jumlah">{{ $totalData }}</div>
        </div>
        <div class="fitur-box">
            <div class="fitur-nama">Pengajuan</div>
            <div class="fitur-jumlah">{{ $totalPengajuan }}</div>
        </div>
    </div>
</div>
@endsection
